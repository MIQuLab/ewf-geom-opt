...
All settings live in the run's `config.yaml`, generated by `calculation_setup.py` — complete examples in [`Examples/Geometry_Optimization_Runs/`](../Examples/Geometry_Optimization_Runs/):
