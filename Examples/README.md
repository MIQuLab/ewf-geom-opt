...
| [`Trp-cage_Single_Point/`](Trp-cage_Single_Point/) | Large-scale single-point energies on folded / unfolded Trp-cage, with reference data from *JCTC* **2026**, *22*, 6041 |
...
> *Journal of Chemical Theory and Computation* **2026**, *22*, 6041.
