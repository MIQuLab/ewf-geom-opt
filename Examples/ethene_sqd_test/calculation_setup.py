...
def build_config(hpc, run_mode, multi, external, proc, geometry="geometry.txt",
    ...
    if sqd:
        ...
        a("  # EITHER point to a pre-collected count_dict.txt (one path or a")
        a("  # per-fragment mapping), OR set sample_on_the_fly: true to run")
        a("  # ffsim + Qiskit SamplerV2 on an IBM backend each time.")
        a("  sample_on_the_fly: false")
        ...
        a("  # qiskit_backend: ibm_cleveland")
        a("  # default_shots: 100000")
        a("  # n_reps: 1")
        a("  # thresh_two_q: 1.0")
        a("  # thresh_meas: 0.10")
