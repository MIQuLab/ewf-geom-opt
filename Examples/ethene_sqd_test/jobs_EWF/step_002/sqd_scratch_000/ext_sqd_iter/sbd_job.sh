...
#SBATCH --output=/mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/ext_sqd_iter/slurm.out
#SBATCH --error=/mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/ext_sqd_iter/slurm.err
...
set -u
STATUS_FILE=/mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/ext_sqd_iter/sbd_job.status
on_exit() {
    rc=$?
    if [ "$rc" -eq 0 ]; then
...
if ! command -v /home/liz7/isilon/Zhen/mpich/bin/mpirun >/dev/null 2>&1; then
    hostname -s > /mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/ext_sqd_iter/mpirun_missing.node 2>/dev/null || true
...
cd /mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/ext_sqd_iter
/home/liz7/isilon/Zhen/mpich/bin/mpirun -np 64 -env OMP_NUM_THREADS 1 /home/liz7/isilon/Zhen/sbd-main/apps/test/diag --fcidump /mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/fci_dump.txt --adetfile /mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/ext_sqd_iter/AlphaDets.txt --bdetfile /mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/ext_sqd_iter/BetaDets.txt --method 0 --block 20 --iteration 10 --tolerance 1e-05 --init 0 --shuffle 0 --carryover_ratio 0.5 --rdm 1 --dump_matrix_form_wf matrixformwf.txt > /mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/ext_sqd_iter/sbd_solver_logfile.log 2>&1
