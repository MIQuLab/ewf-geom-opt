...
#SBATCH --output=/mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/iter_003/batch_000/slurm.out
#SBATCH --error=/mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/iter_003/batch_000/slurm.err
...
set -u
STATUS_FILE=/mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/iter_003/batch_000/sbd_job.status
on_exit() {
    rc=$?
    if [ "$rc" -eq 0 ]; then
...
if ! command -v /home/liz7/isilon/Zhen/mpich/bin/mpirun >/dev/null 2>&1; then
    hostname -s > /mnt/beegfs/merzk/kaliakd/EWF_Geom_Opt_Development/5_test_SQD_deployment/ethene_sqd_test/jobs_EWF/step_002/sqd_scratch_000/iter_003/batch_000/mpirun_missing.node 2>/dev/null || true
