...
idx = int(sys.argv[1])
CLUSTER_FILE = os.path.abspath(f"/mnt/home/shajanak/Documents/CALC/Trp-Cage/c19/c19_zwitter/MP2e5/1_DUMP_CLUST/CLUSTS/clusters_frag{idx}.h5")
SHARE_DIR = os.path.abspath("/mnt/research/MerzGroup/Akhil_EWF_Trp-Cage/shared_data_c19")
