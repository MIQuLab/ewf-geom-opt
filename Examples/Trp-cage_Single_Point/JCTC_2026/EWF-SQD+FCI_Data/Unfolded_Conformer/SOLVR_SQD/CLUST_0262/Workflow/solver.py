...
temp_dir_with_batch_index = workflow_path +'/SBD_tmp/batch_'+str(index)
...
# IMPORTANT: Nuclear repulsion energy is added at the end in callback function.
...
np.savez(workflow_path+'output_batch-'+str(index)+'.npz', **output_dict)
