...
idx = int(sys.argv[1])
CLUSTER_FILE = os.path.abspath(f"/mnt/gs21/scratch/k0095864/c0_zwitter/MP2e5/1_DUMP_CLUST/CLUSTS/clusters_frag{idx}.h5")
SHARE_DIR = os.path.abspath("/mnt/gs21/scratch/k0095864/shared_data_c0")
#EXT_SQD_RDM_PATH = os.path.join("Workflow", "output_batchExtSQD-0.npz")
EXT_SQD_RDM_PATH = os.path.abspath(f"/mnt/gs21/scratch/k0095864/SOLVR_16/CLUST_0000/output_batchExtSQD-0.npz")
